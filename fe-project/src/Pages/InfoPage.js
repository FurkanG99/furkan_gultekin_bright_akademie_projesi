...
const InfoPage = () => {
  ...
  return (
    ...
    <div class="circle ms-1 fs-4 text-white text-center">
  Güncel teknoloji ile portfolionu güçlendir
</div>
  ...
  <div class="card">
    ...
    <div class="circle ms-1 fs-4 text-white text-center">Deneyimli İK eşliğinde iş hayatına katıl</div>
    <div class="circle"></div>
    <div class="card-inner"></div>
  </div>
  <div class="card">
      <h2 className='card-title mt-3'>Eğitim</h2>
    <div class="circle ms-1 fs-4 text-white text-center ">  Full-stack developer olma yolu bizden geçer</div>
    <div class="circle"></div>
    <div class="card-inner"></div>
  </div>
