      ...
      <Container>
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav
            ...
            navbarScroll
          >
            <Nav.Link href="#action1"className='text-white m-2 nav-item fs-5'>BAU Bright Nedir</Nav.Link>
            <Nav.Link href="#action2"className='text-white m-2 nav-item fs-5'>Neden Katılmalıyım</Nav.Link>
