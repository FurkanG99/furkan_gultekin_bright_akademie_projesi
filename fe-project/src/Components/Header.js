...
function Header() {
  const [posts, setPosts] = useState([]);  // Burada posts'u ve setSearchResults'u tanımlayın.
  ...
  <Nav.Link href="/Pages/InfoPage/${pageId}"className='text-white m-2 nav-item fs-5'>BAU Bright Nedir</Nav.Link>
            ...
            <NavDropdown title={<span className="text-white fs-5">Eğitimler</span>} id="navbarScrollingDropdown" className='mt-2 me-5 dropend' style={{ minWidth: '150px' }}>
